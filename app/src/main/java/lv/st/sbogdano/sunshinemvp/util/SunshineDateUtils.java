...
public final class SunshineDateUtils {
   ...
   *
   * @return The number of milliseconds (UTC / GMT) for today's date at midnight in the local time
   * zone
   */
   ...
   * @param showFullDate Used to show a fuller-version of the date, which always contains either the
   * day of the week, today, or tomorrow, in addition to the date.
   * @return A user-friendly representation of the date such as "Today, June 8", "Tomorrow", or
   * "Friday"
   */
